...
address constant PROVER_ADDR = address(
    0xB9200A945f69Deeb19E485ab392eFF3B8575C2F3
);
bytes4 constant PROVER_FUNC_SELECTOR = ZuCitizenshipRegistryProver
    .main
    .selector;
...
contract ZuCitizenshipRegistryWithAttestation is Verifier, ISPHook {
    ...
    function registerCitizenByOwner(
        address _citizen,
        uint256 _expiration
    ) external onlyOwner {
    ...
    function inviteCitizen(
        ...
        emit Invited(_msgSender(), inviteeAddress);
